...
- 关闭新版 Codex 的多代理工具，避免画像分析和普通聊天因触发子代理活动而中断。
- 兼容旧版 Codex CLI 的配置格式，避免创建或恢复会话时因 `agents.enabled` 类型不兼容而失败。
...
[2.0.1]: https://github.com/ia319/v2er-insight/compare/v2.0.0...v2.0.1
